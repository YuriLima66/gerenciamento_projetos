...
INSERT INTO projetos (nome, descricao, data_inicio, data_fim, lider_id, departamento_id, membro_id) VALUES 
  ('Sistema de Gestão de Estoque', 'Desenvolvimento de um sistema web para gerenciar o estoque da empresa.', '2023-03-15', '2023-06-30', 1, 1, 1),
  ('Novo Site da Empresa', 'Criação de um novo site responsivo para a empresa.', '2023-04-01', '2023-07-15', 2, 2, 2),
  ('Campanha de Marketing Digital', 'Implementação de uma campanha de marketing digital para aumentar a visibilidade da empresa.', '2023-05-01', '2023-08-31', 3, 2, 3),
  ('Sistema de Recrutamento Online', 'Desenvolvimento de um sistema online para gerenciar processos de recrutamento.', '2023-06-01', '2023-09-30', 4, 4, 4),
  ('Relatório Anual de Finanças', 'Elaboração do relatório anual de finanças da empresa.', '2023-07-01', '2023-10-31', 5, 5, 5),
  ('Implementação de um novo sistema de logística', 'Implementação de um novo sistema de logística para otimizar a cadeia de suprimentos.', '2023-08-01', '2023-11-30', 6, 6, 6),
  ('Modernização da linha de produção', 'Modernização da linha de produção para aumentar a eficiência e qualidade.', '2023-09-01', '2023-12-31', 7, 7, 7),
  ('Pesquisa de novos materiais', 'Pesquisa de novos materiais para desenvolver produtos inovadores.', '2023-10-01', '2024-01-31', 8, 8, 8),
  ('Implementação de um novo sistema de atendimento ao cliente', 'Implementação de um novo sistema de atendimento ao cliente para melhorar a experiência do cliente.', '2023-11-01', '2024-02-28', 9, 9, 9),
  ('Migração para a nuvem', 'Migração dos sistemas da empresa para a nuvem.', '2023-12-01', '2024-03-31', 10, 10, 10),
  ('Atualização do sistema jurídico', 'Atualização do sistema jurídico para garantir conformidade com as leis.', '2024-01-01', '2024-04-30', 11, 11, 11),
  ('Reestruturação da área administrativa', 'Reestruturação da área administrativa para otimizar os processos.', '2024-02-01', '2024-05-31', 12, 12, 12),
  ('Lançamento de um novo produto', 'Lançamento de um novo produto no mercado.', '2024-03-01', '2024-06-30', 13, 13, 13),
  ('Construção de uma nova fábrica', 'Construção de uma nova fábrica para aumentar a capacidade de produção.', '2024-04-01', '2024-07-31', 14, 14, 14),
  ('Implementação de um novo sistema de gestão de operações', 'Implementação de um novo sistema de gestão de operações para otimizar os processos.', '2024-05-01', '2024-08-31', 15, 15, 15),
  ('Implementação de um sistema de gestão de qualidade', 'Implementação de um sistema de gestão de qualidade para garantir a qualidade dos produtos/serviços.', '2024-06-01', '2024-09-30', 16, 16, 16),
  ('Implementação de um sistema de segurança', 'Implementação de um sistema de segurança para proteger a empresa e seus funcionários.', '2024-07-01', '2024-10-31', 17, 17, 17),
  ('Modernização do sistema de compras', 'Modernização do sistema de compras para otimizar os processos.', '2024-08-01', '2024-11-30', 18, 18, 18),
  ('Manutenção preventiva dos equipamentos', 'Realizar manutenção preventiva dos equipamentos para garantir o bom funcionamento.', '2024-09-01', '2024-12-31', 19, 19, 19),
  ('Lançamento de uma nova campanha de comunicação', 'Lançamento de uma nova campanha de comunicação para comunicar os valores da empresa.', '2024-10-01', '2025-01-31', 20, 20, 20);
...
INSERT INTO tarefas (projeto_id, nome, descricao, data_inicio, data_fim, prioridade_id, responsavel_id, status) VALUES
  ...
  (20, 'Lançamento de uma nova campanha de comunicação', 'Lançamento de uma nova campanha de comunicação para comunicar os valores da empresa.', '2024-10-01', '2025-01-31', 2, 20, 'Em andamento');